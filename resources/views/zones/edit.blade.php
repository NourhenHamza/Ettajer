                ...
                <div class="card-body">
                    <form action="{{ route('zones.update', $zone->id) }}" method="POST">
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Zone Name" value="{{ $zone->name }}" required />
                        ...
                        <div class="form-floating form-floating-outline mb-4">
                            <input type="text" class="form-control" id="cities" name="cities" placeholder="Cities" value="{{ $zone->cities }}" readonly />
